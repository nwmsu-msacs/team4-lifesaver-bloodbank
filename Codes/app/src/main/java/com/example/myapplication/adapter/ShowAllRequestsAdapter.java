...
public class ShowAllRequestsAdapter extends RecyclerView.Adapter<ShowAllRequestsAdapter.MyViewHolder> {

     ArrayList<ShowAllRequestsModel> dataSet;

    Context context;
    public ShowAllRequestsAdapter(ArrayList<ShowAllRequestsModel> data) {
        this.dataSet = data;
    }
    ...
    //    TextView requestAcceptedBy=holder.requestAcceptedBy;
       ...
       // pNoOfUnits.setText(":   "+dataSet.get(position).getpNoOfUnits());
        ...
        patientAddress.setText(":   "+dataSet.get(position).getHospitalAddress());
   ...
   //     TextView requestAcceptedBy;
    //    TextView requestStatus;
        ...
        public MyViewHolder(View itemView) {
            ...
            this.editRequest.setVisibility(View.GONE);

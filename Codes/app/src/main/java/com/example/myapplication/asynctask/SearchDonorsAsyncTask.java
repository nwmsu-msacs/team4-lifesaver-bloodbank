...
public class SearchDonorsAsyncTask extends AsyncTask {
    ...
    public SearchDonorsAsyncTask(Context context){
    ...
    protected Object doInBackground(Object[] params) {
        ...
        response= JSONParser.makeHttpRequest(context, ApplicationHolder.base_url+ApplicationHolder.search_donors_url+params[0], "GET", null);
        if(response!=null){
            try {
                message = true;
